...
import { delMessage } from '../../../../../../store/chatlist/actions';
import { selectChatList, selectChats } from '../../../../../../store/chatlist/selectors';
...
export const ButtonDel: FC = () => {
  ...
  const chat = useSelector(selectChatList)
  const { chatId } = useParams();
  
  return(
  <button className={style.delbutton} onClick={() => dispatch(delMessage(chatId)) } type="button">
    <svg
